...
use pmf\helpers\html\tables\EditTable;
use pmf\helpers\html\forms\FormElement;
use pmf\helpers\html\forms\InputCheckBox;
use pmf\helpers\html\forms\InputText;
use pmf\helpers\html\forms\Form;
...
class Admin extends PageBody {
     ...
     *
     * @return pmf\helpers\html\forms\Form
     */
    ...
    public function initConfig(Config $data){
        ...
        $this->form->addElement(new InputText(
        	'tplExtension', _('Template files extension'), 200, $this->data->getTemplateExt())
        );
        $this->form->addElement(new InputText(
        	'tplPath', _('Template path'), 200, $this->data->getTemplatePath())
        );
        $this->form->addElement(new InputCheckBox(
